...
test_data = MyDataset(txt='dataset-val.txt', root=data_root, transform=transform)
...
def main():
    ...
    for i, data in enumerate(test_dataloader, 0):
        ...
        for j in range(len(test_img)):
            ...
            ssim_adv_ori_list.append(compare_ssim(adv, ori, data_range=255, multichannel=True))
            ...
            ssim_r_ori_list.append(compare_ssim(r_a, ori, data_range=255, multichannel=True))
